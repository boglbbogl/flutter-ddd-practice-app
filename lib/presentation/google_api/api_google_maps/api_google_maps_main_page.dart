...
import 'package:ddd_practice_app/presentation/google_api/api_google_maps/widgets/google_maps_page.dart';
...
class ApiGoogleMapsMainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ApiGoogleMapsMainBloc>(
      create: (context) => getIt<ApiGoogleMapsMainBloc>(),
      child: BlocBuilder<ApiGoogleMapsMainBloc, ApiGoogleMapsMainState>(
