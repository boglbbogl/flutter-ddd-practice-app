...
class WorkingTitleTravelSearchForm extends StatelessWidget {
  final String startPlace;
  final TextEditingController controller = TextEditingController();

  WorkingTitleTravelSearchForm({
    Key? key,
                          ...
                          onTap: () {
                            if (startPlace.isEmpty) {
                              context.read<WorkingTitleTravelCreateBloc>().add(
                                  WorkingTitleTravelCreateEvent.travelStart(
                                      start: [e.latitude, e.longitude],
                                      startPlaceName: e.placeName));
                            } else {
                              context.read<WorkingTitleTravelCreateBloc>().add(
                                  WorkingTitleTravelCreateEvent.travelEnd(
