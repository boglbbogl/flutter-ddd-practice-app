...
class CeoplusWebview extends StatefulWidget {
  const CeoplusWebview({Key? key}) : super(key: key);

  @override
  CeoplusWebviewState createState() => CeoplusWebviewState();
}

class CeoplusWebviewState extends State<CeoplusWebview> {
  late InAppWebViewController webViewController;

  static const platform = MethodChannel('com.intent');
