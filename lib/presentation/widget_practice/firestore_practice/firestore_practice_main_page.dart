...
import 'package:ddd_practice_app/application/widget_practice/firestore_practice/firestore_create_main_bloc.dart';
...
class FirestorePracticeMainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<FirestoreCreateMainBloc>(
      create: (context) => getIt<FirestoreCreateMainBloc>()
        ..add(const FirestoreCreateMainEvent.started()),
      child: Scaffold(
        appBar: appBarForm(
          context,
          theme,
