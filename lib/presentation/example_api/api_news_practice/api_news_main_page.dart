...
import 'package:ddd_practice_app/application/example_api/api_news_practice/api_news_main_bloc.dart';
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: ListView(
              shrinkWrap: true,
              children: [
                ...state.apiNews!.articles.map((news) => InkWell(
                      onTap: () {
                        context.read<ApiNewsMainBloc>().add(
                            ApiNewsMainEvent.pageChangedToUrl(url: news.url));
                      },
                      child: Padding(
                        padding:
