...
import 'package:ddd_practice_app/presentation/public_api/api_public_electric_station/widgets/electric_station_google_maps.dart';
...
class ElectricStationAddressDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ElectricStationGoogleMaps()
            .electricStationGoogleMaps(context: context, ev: ev, myGeo: myGeo);
      },
      child: Padding(
