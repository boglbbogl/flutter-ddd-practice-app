...
import 'application/community_practice/community_main_bloc/community_main_bloc.dart'
    as _i22;
import 'application/main/main_cubit.dart' as _i14;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i12.IMemberRepository>(
      () => _i13.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i14.MainCubit>(() => _i14.MainCubit());
  gh.factory<_i15.MemberCreateBloc>(
      () => _i15.MemberCreateBloc(get<_i12.IMemberRepository>()));
  gh.factory<_i16.MemberMainBloc>(
  ...
  gh.factory<_i20.CommunityDeleteCubit>(
      () => _i20.CommunityDeleteCubit(get<_i10.ICommunityRepository>()));
  gh.factory<_i21.CommunityDetailBloc>(
      () => _i21.CommunityDetailBloc(get<_i10.ICommunityRepository>()));
  gh.factory<_i22.CommunityMainBloc>(
      () => _i22.CommunityMainBloc(get<_i10.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i23.FirebaseInjectableMudule {}
