...
import 'package:firebase_remote_config/firebase_remote_config.dart' as _i56;
import 'package:firebase_storage/firebase_storage.dart' as _i5;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;

import 'application/_main/main_cubit.dart' as _i53;
...
import 'application/widget_practice/slide_matrix_practice/slide_matrix_practice_main_cubit.dart'
    as _i57;
import 'domain/core/geo_location/i_geo_location_repository.dart' as _i47;
...
import 'domain/project_app/working_title_travel_app/i_working_title_travel_repository.dart'
    as _i51;
import 'domain/public_api/api_public_corona/i_api_public_corona_repository.dart'
    as _i37;
...
import 'infrastructure/core/geo_location/geo_location_repository.dart' as _i48;
...
import 'infrastructure/project_app/working_title_travel_app/working_title_travel_plan_repository.dart'
    as _i52;
import 'infrastructure/public_api/api_public_corona/api_public_corona_repository.dart'
    as _i38;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i39.IApiPublicElectricStationRepository>(
      () => _i40.ApiPublicStationRepository());
  gh.lazySingleton<_i41.IApiWeatherRepository>(
      () => _i42.ApiWeatherRepository());
  gh.lazySingleton<_i43.ICommunityRepository>(
      () => _i44.CommunityRepository(get<_i4.FirebaseFirestore>()));
  gh.lazySingleton<_i45.IFirestorePracticeRepository>(
      () => _i46.FirestorePracticeRepository(get<_i4.FirebaseFirestore>()));
  gh.lazySingleton<_i47.IGeoLocationRepository>(
      () => _i48.GeoLocationRepository());
  gh.lazySingleton<_i49.IMemberRepository>(
      () => _i50.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  gh.lazySingleton<_i51.IWorkingTitleTravelRepository>(() =>
      _i52.WorkingTitleTravelPlanRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i53.MainCubit>(() => _i53.MainCubit());
  gh.factory<_i54.MemberCreateBloc>(
      () => _i54.MemberCreateBloc(get<_i49.IMemberRepository>()));
  gh.factory<_i55.MemberMainBloc>(
      () => _i55.MemberMainBloc(get<_i49.IMemberRepository>()));
  gh.lazySingleton<_i56.RemoteConfig>(
      () => firebaseInjectableMudule.remoteConfig);
  gh.factory<_i57.SlideMatrixPracticeMainCubit>(
      () => _i57.SlideMatrixPracticeMainCubit());
  gh.factory<_i58.WorkingTitleTravelCreateBloc>(() =>
      _i58.WorkingTitleTravelCreateBloc(
          get<_i51.IWorkingTitleTravelRepository>()));
  gh.factory<_i59.WorkingTitleTravelMainCubit>(() =>
      _i59.WorkingTitleTravelMainCubit(
          get<_i51.IWorkingTitleTravelRepository>()));
  gh.factory<_i60.ApiGoogleMapsMainBloc>(
      () => _i60.ApiGoogleMapsMainBloc(get<_i47.IGeoLocationRepository>()));
  gh.factory<_i61.ApiKakaoBookMainBloc>(
      () => _i61.ApiKakaoBookMainBloc(get<_i7.IApiKakaoBookRepository>()));
  gh.factory<_i62.ApiKakaoDetectLangMainBloc>(() =>
      _i62.ApiKakaoDetectLangMainBloc(
          get<_i9.IApiKakaoDetectLangRepository>()));
  gh.factory<_i63.ApiKakaoImageMainBloc>(
      () => _i63.ApiKakaoImageMainBloc(get<_i11.IApiKakaoImageRepository>()));
  gh.factory<_i64.ApiKakaoLocalAddressMainCubit>(() =>
      _i64.ApiKakaoLocalAddressMainCubit(
          get<_i13.IApiKakaoLocalAddressRepository>(),
          get<_i41.IApiWeatherRepository>(),
          get<_i47.IGeoLocationRepository>()));
  gh.factory<_i65.ApiKakaoLocalKeywordMainBloc>(() =>
      _i65.ApiKakaoLocalKeywordMainBloc(
          get<_i15.IApiKakaoLocalKeywordRepository>()));
  gh.factory<_i66.ApiKakaoTranslateMainCubit>(() =>
      _i66.ApiKakaoTranslateMainCubit(
          get<_i17.IApiKakaoTranslateRepository>()));
  gh.factory<_i67.ApiKakaoVideoMainBloc>(
      () => _i67.ApiKakaoVideoMainBloc(get<_i19.IApiKakaoVideoRepository>()));
  gh.factory<_i68.ApiKakaoWebMainCubit>(
      () => _i68.ApiKakaoWebMainCubit(get<_i21.IApiKakaoWebRepository>()));
  gh.factory<_i69.ApiNaverImageMainBloc>(
      () => _i69.ApiNaverImageMainBloc(get<_i23.IApiNaverImageRepository>()));
  gh.factory<_i70.ApiNaverMovieMainBloc>(
      () => _i70.ApiNaverMovieMainBloc(get<_i25.IApiNaverMovieRepository>()));
  gh.factory<_i71.ApiNaverPapagoMainBloc>(
      () => _i71.ApiNaverPapagoMainBloc(get<_i27.IApiNaverPapagoRepository>()));
  gh.factory<_i72.ApiNaverRomanizationMainCubit>(() =>
      _i72.ApiNaverRomanizationMainCubit(
          get<_i29.IApiNaverRomanizationRepository>()));
  gh.factory<_i73.ApiNaverShopMainBloc>(
      () => _i73.ApiNaverShopMainBloc(get<_i31.IApiNaverShopRepository>()));
  gh.factory<_i74.ApiNewsMainBloc>(
      () => _i74.ApiNewsMainBloc(get<_i33.IApiNewsRepository>()));
  gh.factory<_i75.ApiPictureCubit>(
      () => _i75.ApiPictureCubit(get<_i35.IApiPictureRepository>()));
  gh.factory<_i76.ApiPublicCoronaMainCubit>(() =>
      _i76.ApiPublicCoronaMainCubit(get<_i37.IApiPublicCoronaRepository>()));
  gh.factory<_i77.ApiPublicElectricStationAddressBloc>(() =>
      _i77.ApiPublicElectricStationAddressBloc(
          get<_i39.IApiPublicElectricStationRepository>(),
          get<_i47.IGeoLocationRepository>()));
  gh.factory<_i78.ApiPublicElectricStationCourseBloc>(() =>
      _i78.ApiPublicElectricStationCourseBloc(
          get<_i47.IGeoLocationRepository>(),
          get<_i13.IApiKakaoLocalAddressRepository>(),
          get<_i39.IApiPublicElectricStationRepository>()));
  gh.factory<_i79.ApiPublicElectricStationSearchBloc>(() =>
      _i79.ApiPublicElectricStationSearchBloc(
          get<_i47.IGeoLocationRepository>(),
          get<_i13.IApiKakaoLocalAddressRepository>(),
          get<_i39.IApiPublicElectricStationRepository>()));
  gh.factory<_i80.ApiWeatherMainCubit>(() => _i80.ApiWeatherMainCubit(
      get<_i41.IApiWeatherRepository>(), get<_i47.IGeoLocationRepository>()));
  gh.factory<_i81.CommunityDeleteCubit>(
      () => _i81.CommunityDeleteCubit(get<_i43.ICommunityRepository>()));
  gh.factory<_i82.CommunityDetailBloc>(
      () => _i82.CommunityDetailBloc(get<_i43.ICommunityRepository>()));
  gh.factory<_i83.CommunityMainBloc>(
      () => _i83.CommunityMainBloc(get<_i43.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i84.FirebaseInjectableMudule {}
