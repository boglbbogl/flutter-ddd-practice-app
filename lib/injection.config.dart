...
import 'domain/naver_api/api_naver_shop_practice/i_api_naver_shop_repository.dart'
    as _i20;
import 'infrastructure/core/firebase_injectable_module.dart' as _i50;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i28.ICommunityRepository>(
      () => _i29.CommunityRepository(get<_i4.FirebaseFirestore>()));
  gh.lazySingleton<_i30.IMemberRepository>(
      () => _i31.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  ...
  gh.factory<_i36.ApiKakaoBookMainBloc>(
      () => _i36.ApiKakaoBookMainBloc(get<_i6.IApiKakaoBookRepository>()));
  ...
  gh.factory<_i38.ApiKakaoImageMainBloc>(
      () => _i38.ApiKakaoImageMainBloc(get<_i10.IApiKakaoImageRepository>()));
  ...
  gh.factory<_i40.ApiKakaoWebMainCubit>(
      () => _i40.ApiKakaoWebMainCubit(get<_i14.IApiKakaoWebRepository>()));
  gh.factory<_i41.ApiNaverImageMainBloc>(
      () => _i41.ApiNaverImageMainBloc(get<_i16.IApiNaverImageRepository>()));
  gh.factory<_i42.ApiNaverPapagoMainBloc>(
      () => _i42.ApiNaverPapagoMainBloc(get<_i18.IApiNaverPapagoRepository>()));
  gh.factory<_i43.ApiNaverShopMainBloc>(
      () => _i43.ApiNaverShopMainBloc(get<_i20.IApiNaverShopRepository>()));
  gh.factory<_i44.ApiNewsMainBloc>(
      () => _i44.ApiNewsMainBloc(get<_i22.IApiNewsRepository>()));
  gh.factory<_i45.ApiPictureCubit>(
      () => _i45.ApiPictureCubit(get<_i24.IApiPictureRepository>()));
  gh.factory<_i46.ApiWeatherMainCubit>(
      () => _i46.ApiWeatherMainCubit(get<_i26.IApiWeatherRepository>()));
  gh.factory<_i47.CommunityDeleteCubit>(
      () => _i47.CommunityDeleteCubit(get<_i28.ICommunityRepository>()));
  gh.factory<_i48.CommunityDetailBloc>(
      () => _i48.CommunityDetailBloc(get<_i28.ICommunityRepository>()));
  gh.factory<_i49.CommunityMainBloc>(
      () => _i49.CommunityMainBloc(get<_i28.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i50.FirebaseInjectableMudule {}
