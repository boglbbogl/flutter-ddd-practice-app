...
import 'application/api_news_practice/api_news_main_bloc.dart' as _i20;
import 'application/api_picture_practice/api_picture_cubit.dart' as _i21;
...
import 'domain/api_news_practice/i_api_news_repository.dart' as _i6;
import 'domain/api_picture_practice/i_api_picture_repository.dart' as _i8;
import 'domain/api_weather_practice/i_api_weather_repository.dart' as _i10;
import 'domain/community_practice/i_community_repository.dart' as _i12;
import 'domain/member_practice/i_member_repository.dart' as _i14;
import 'infrastructure/api_news_practice/api_news_repository.dart' as _i7;
import 'infrastructure/api_picture_practice/api_picture_repository.dart' as _i9;
import 'infrastructure/api_weather_practice/api_weather_repository.dart'
    as _i11;
import 'infrastructure/community_practice/community_repository.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.IApiNewsRepository>(() => _i7.ApiNewsRepository());
  gh.lazySingleton<_i8.IApiPictureRepository>(() => _i9.ApiExampleRepository());
  gh.lazySingleton<_i10.IApiWeatherRepository>(
      () => _i11.ApiWeatherRepository());
  gh.lazySingleton<_i12.ICommunityRepository>(
      () => _i13.CommunityRepository(get<_i4.FirebaseFirestore>()));
  ...
  gh.factory<_i20.ApiNewsMainBloc>(
      () => _i20.ApiNewsMainBloc(get<_i6.IApiNewsRepository>()));
  gh.factory<_i21.ApiPictureCubit>(
      () => _i21.ApiPictureCubit(get<_i8.IApiPictureRepository>()));
  gh.factory<_i22.ApiWeatherMainCubit>(
      () => _i22.ApiWeatherMainCubit(get<_i10.IApiWeatherRepository>()));
  gh.factory<_i23.CommunityDeleteCubit>(
      () => _i23.CommunityDeleteCubit(get<_i12.ICommunityRepository>()));
  gh.factory<_i24.CommunityDetailBloc>(
      () => _i24.CommunityDetailBloc(get<_i12.ICommunityRepository>()));
  gh.factory<_i25.CommunityMainBloc>(
      () => _i25.CommunityMainBloc(get<_i12.ICommunityRepository>()));
  return get;
}
