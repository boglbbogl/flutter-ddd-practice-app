...
import 'application/member_practice/member_create/bloc/member_create_bloc.dart'
    as _i11;
import 'application/member_practice/member_main/member_main_bloc.dart' as _i12;
import 'domain/community_practice/i_community_repository.dart' as _i6;
import 'domain/member_practice/i_member_repository.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.IMemberRepository>(
      () => _i9.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i10.MainCubit>(() => _i10.MainCubit());
  gh.factory<_i11.MemberCreateBloc>(
      () => _i11.MemberCreateBloc(get<_i8.IMemberRepository>()));
  gh.factory<_i12.MemberMainBloc>(
      () => _i12.MemberMainBloc(get<_i8.IMemberRepository>()));
  gh.lazySingleton<_i13.RemoteConfig>(
      () => firebaseInjectableMudule.remoteConfig);
  gh.factory<_i14.CommunityDeleteCubit>(
      () => _i14.CommunityDeleteCubit(get<_i6.ICommunityRepository>()));
  gh.factory<_i15.CommunityDetailBloc>(
      () => _i15.CommunityDetailBloc(get<_i6.ICommunityRepository>()));
  gh.factory<_i16.CommunityMainBloc>(
      () => _i16.CommunityMainBloc(get<_i6.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i17.FirebaseInjectableMudule {}
