...
import 'application/community_practice/community_main_bloc/community_main_bloc.dart'
    as _i12;
import 'application/main/main_cubit.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i9.RemoteConfig>(
      () => firebaseInjectableMudule.remoteConfig);
  gh.factory<_i10.CommunityDeleteCubit>(
      () => _i10.CommunityDeleteCubit(get<_i6.ICommunityRepository>()));
  gh.factory<_i11.CommunityDetailBloc>(
      () => _i11.CommunityDetailBloc(get<_i6.ICommunityRepository>()));
  gh.factory<_i12.CommunityMainBloc>(
      () => _i12.CommunityMainBloc(get<_i6.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i13.FirebaseInjectableMudule {}
