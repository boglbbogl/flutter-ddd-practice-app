...
import 'package:firebase_remote_config/firebase_remote_config.dart' as _i43;
...
import 'application/kakao_api/api_kakao_web_practice/api_kakao_web_main_cubit.dart'
    as _i51;
import 'application/main/main_cubit.dart' as _i40;
...
import 'application/widget_practice/member_practice/member_main/member_main_bloc.dart'
    as _i42;
import 'domain/community_practice/i_community_repository.dart' as _i34;
import 'domain/core/geo_location/i_geo_location_repository.dart' as _i36;
...
import 'domain/kakao_api/api_kakao_web_practice/i_api_kakao_web_repository.dart'
    as _i18;
import 'domain/member_practice/i_member_repository.dart' as _i38;
...
import 'infrastructure/core/geo_location/geo_location_repository.dart' as _i37;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i22.IApiNaverPapagoRepository>(
      () => _i23.ApiNaverPapagoRepository());
  gh.lazySingleton<_i24.IApiNaverRomanizationRepository>(
      () => _i25.ApiNaverRomanizationRepository());
  gh.lazySingleton<_i26.IApiNaverShopRepository>(
      () => _i27.ApiNaverShopRepository());
  gh.lazySingleton<_i28.IApiNewsRepository>(() => _i29.ApiNewsRepository());
  gh.lazySingleton<_i30.IApiPictureRepository>(
      () => _i31.ApiExampleRepository());
  gh.lazySingleton<_i32.IApiWeatherRepository>(
      () => _i33.ApiWeatherRepository());
  gh.lazySingleton<_i34.ICommunityRepository>(
      () => _i35.CommunityRepository(get<_i4.FirebaseFirestore>()));
  gh.lazySingleton<_i36.IGeoLocationRepository>(
      () => _i37.GeoLocationRepository());
  gh.lazySingleton<_i38.IMemberRepository>(
      () => _i39.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i40.MainCubit>(() => _i40.MainCubit());
  gh.factory<_i41.MemberCreateBloc>(
      () => _i41.MemberCreateBloc(get<_i38.IMemberRepository>()));
  gh.factory<_i42.MemberMainBloc>(
      () => _i42.MemberMainBloc(get<_i38.IMemberRepository>()));
  gh.lazySingleton<_i43.RemoteConfig>(
      () => firebaseInjectableMudule.remoteConfig);
  gh.factory<_i44.ApiGoogleMapsMainBloc>(
      () => _i44.ApiGoogleMapsMainBloc(get<_i36.IGeoLocationRepository>()));
  gh.factory<_i45.ApiKakaoBookMainBloc>(
      () => _i45.ApiKakaoBookMainBloc(get<_i6.IApiKakaoBookRepository>()));
  gh.factory<_i46.ApiKakaoDetectLangMainBloc>(() =>
      _i46.ApiKakaoDetectLangMainBloc(
          get<_i8.IApiKakaoDetectLangRepository>()));
  gh.factory<_i47.ApiKakaoImageMainBloc>(
      () => _i47.ApiKakaoImageMainBloc(get<_i10.IApiKakaoImageRepository>()));
  gh.factory<_i48.ApiKakaoLocalAddressMainCubit>(() =>
      _i48.ApiKakaoLocalAddressMainCubit(
          get<_i12.IApiKakaoLocalAddressRepository>(),
          get<_i32.IApiWeatherRepository>(),
          get<_i36.IGeoLocationRepository>()));
  gh.factory<_i49.ApiKakaoLocalKeywordMainBloc>(() =>
      _i49.ApiKakaoLocalKeywordMainBloc(
          get<_i14.IApiKakaoLocalKeywordRepository>()));
  gh.factory<_i50.ApiKakaoTranslateMainCubit>(() =>
      _i50.ApiKakaoTranslateMainCubit(
          get<_i16.IApiKakaoTranslateRepository>()));
  gh.factory<_i51.ApiKakaoWebMainCubit>(
      () => _i51.ApiKakaoWebMainCubit(get<_i18.IApiKakaoWebRepository>()));
  gh.factory<_i52.ApiNaverImageMainBloc>(
      () => _i52.ApiNaverImageMainBloc(get<_i20.IApiNaverImageRepository>()));
  gh.factory<_i53.ApiNaverPapagoMainBloc>(
      () => _i53.ApiNaverPapagoMainBloc(get<_i22.IApiNaverPapagoRepository>()));
  gh.factory<_i54.ApiNaverRomanizationMainCubit>(() =>
      _i54.ApiNaverRomanizationMainCubit(
          get<_i24.IApiNaverRomanizationRepository>()));
  gh.factory<_i55.ApiNaverShopMainBloc>(
      () => _i55.ApiNaverShopMainBloc(get<_i26.IApiNaverShopRepository>()));
  gh.factory<_i56.ApiNewsMainBloc>(
      () => _i56.ApiNewsMainBloc(get<_i28.IApiNewsRepository>()));
  gh.factory<_i57.ApiPictureCubit>(
      () => _i57.ApiPictureCubit(get<_i30.IApiPictureRepository>()));
  gh.factory<_i58.ApiWeatherMainCubit>(() => _i58.ApiWeatherMainCubit(
      get<_i32.IApiWeatherRepository>(), get<_i36.IGeoLocationRepository>()));
  gh.factory<_i59.CommunityDeleteCubit>(
      () => _i59.CommunityDeleteCubit(get<_i34.ICommunityRepository>()));
  gh.factory<_i60.CommunityDetailBloc>(
      () => _i60.CommunityDetailBloc(get<_i34.ICommunityRepository>()));
  gh.factory<_i61.CommunityMainBloc>(
      () => _i61.CommunityMainBloc(get<_i34.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i62.FirebaseInjectableMudule {}
