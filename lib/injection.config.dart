...
import 'application/kakao_api/api_kakao_web_practice/api_kakao_web_main_cubit.dart'
    as _i48;
import 'application/main/main_cubit.dart' as _i38;
...
import 'domain/core/geo_location/i_geo_location_repository.dart' as _i34;
...
import 'domain/kakao_api/api_kakao_web_practice/i_api_kakao_web_repository.dart'
    as _i16;
import 'domain/member_practice/i_member_repository.dart' as _i36;
...
import 'infrastructure/core/geo_location/geo_location_repository.dart' as _i35;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i34.IGeoLocationRepository>(
      () => _i35.GeoLocationRepository());
  gh.lazySingleton<_i36.IMemberRepository>(
      () => _i37.FriendsSelectionRepository(get<_i4.FirebaseFirestore>()));
  gh.factory<_i38.MainCubit>(() => _i38.MainCubit());
  gh.factory<_i39.MemberCreateBloc>(
      () => _i39.MemberCreateBloc(get<_i36.IMemberRepository>()));
  gh.factory<_i40.MemberMainBloc>(
      () => _i40.MemberMainBloc(get<_i36.IMemberRepository>()));
  gh.lazySingleton<_i41.RemoteConfig>(
      () => firebaseInjectableMudule.remoteConfig);
  gh.factory<_i42.ApiGoogleMapsMainBloc>(
      () => _i42.ApiGoogleMapsMainBloc(get<_i34.IGeoLocationRepository>()));
  gh.factory<_i43.ApiKakaoBookMainBloc>(
      () => _i43.ApiKakaoBookMainBloc(get<_i6.IApiKakaoBookRepository>()));
  gh.factory<_i44.ApiKakaoDetectLangMainBloc>(() =>
      _i44.ApiKakaoDetectLangMainBloc(
          get<_i8.IApiKakaoDetectLangRepository>()));
  gh.factory<_i45.ApiKakaoImageMainBloc>(
      () => _i45.ApiKakaoImageMainBloc(get<_i10.IApiKakaoImageRepository>()));
  gh.factory<_i46.ApiKakaoLocalAddressMainCubit>(() =>
      _i46.ApiKakaoLocalAddressMainCubit(
          get<_i12.IApiKakaoLocalAddressRepository>(),
          get<_i30.IApiWeatherRepository>(),
          get<_i34.IGeoLocationRepository>()));
  gh.factory<_i47.ApiKakaoTranslateMainCubit>(() =>
      _i47.ApiKakaoTranslateMainCubit(
          get<_i14.IApiKakaoTranslateRepository>()));
  gh.factory<_i48.ApiKakaoWebMainCubit>(
      () => _i48.ApiKakaoWebMainCubit(get<_i16.IApiKakaoWebRepository>()));
  gh.factory<_i49.ApiNaverImageMainBloc>(
      () => _i49.ApiNaverImageMainBloc(get<_i18.IApiNaverImageRepository>()));
  gh.factory<_i50.ApiNaverPapagoMainBloc>(
      () => _i50.ApiNaverPapagoMainBloc(get<_i20.IApiNaverPapagoRepository>()));
  gh.factory<_i51.ApiNaverRomanizationMainCubit>(() =>
      _i51.ApiNaverRomanizationMainCubit(
          get<_i22.IApiNaverRomanizationRepository>()));
  gh.factory<_i52.ApiNaverShopMainBloc>(
      () => _i52.ApiNaverShopMainBloc(get<_i24.IApiNaverShopRepository>()));
  gh.factory<_i53.ApiNewsMainBloc>(
      () => _i53.ApiNewsMainBloc(get<_i26.IApiNewsRepository>()));
  gh.factory<_i54.ApiPictureCubit>(
      () => _i54.ApiPictureCubit(get<_i28.IApiPictureRepository>()));
  gh.factory<_i55.ApiWeatherMainCubit>(() => _i55.ApiWeatherMainCubit(
      get<_i30.IApiWeatherRepository>(), get<_i34.IGeoLocationRepository>()));
  gh.factory<_i56.CommunityDeleteCubit>(
      () => _i56.CommunityDeleteCubit(get<_i32.ICommunityRepository>()));
  gh.factory<_i57.CommunityDetailBloc>(
      () => _i57.CommunityDetailBloc(get<_i32.ICommunityRepository>()));
  gh.factory<_i58.CommunityMainBloc>(
      () => _i58.CommunityMainBloc(get<_i32.ICommunityRepository>()));
  return get;
}

class _$FirebaseInjectableMudule extends _i59.FirebaseInjectableMudule {}
