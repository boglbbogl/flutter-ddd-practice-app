...
class _$_ApiPublicCoronaMainState implements _ApiPublicCoronaMainState {
  _$_ApiPublicCoronaMainState(
      {required this.isLoading, required this.corona, required this.orFailure});
  ...
  @override
  String toString() {
    return 'ApiPublicCoronaMainState(isLoading: $isLoading, corona: $corona, orFailure: $orFailure)';
  }
